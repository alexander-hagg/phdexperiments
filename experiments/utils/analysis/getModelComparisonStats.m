...
parse.addOptional('includesamples',false);
...
stats.useSamples                = parse.Results.includesamples;
...
mapElements = {d.express, d.categorize, d.featureMin, d.featureMax, d.alignedMap};
cfg.express = mapElements{1};cfg.categorize = mapElements{2};cfg.featureMin = mapElements{3};cfg.featureMax = mapElements{4};cfg.alignedMap = mapElements{5};
...
if stats.useSamples
    for i=1:length(experiments)
        optimaLocations = [optimaLocations; experiments{i}.samples.genes];
    end
