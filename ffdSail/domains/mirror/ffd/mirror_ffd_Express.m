...
if ~precomputed
    ...
    % Rescale 
    scaling = 0.3;
    mirrorPlane = scaling*mirrorPlane;
    centerStill = scaling*centerStill;
...
for iDeforms = 1:nDeforms
    ...
    %newMeshPoints_denorm = STLMeshpoints'.*normalizationFactors.yrange + normalizationFactors.xmin;
