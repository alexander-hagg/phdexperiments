...
parse.addOptional('runFolder', '/home/alex/Documents/phd/repositories/cai');
...
rmpath(genpath('domains/mirrorDomain'));
addpath(genpath('domains/mirrorDomain/'));
...
if d.hpc
    ...
    if d.lowres
        d.openFoamTemplate = [d.runFolder '/domains/mirrorDomain/pe/ofTemplates/hpc1_short'];
    elseif d.mirrorOnly
        d.openFoamTemplate = [d.runFolder '/domains/mirrorDomain/pe/ofTemplates/hpc1_mirror_only'];        
    else
        d.openFoamTemplate = [d.runFolder '/domains/mirrorDomain/pe/ofTemplates/hpc1'];
    end
