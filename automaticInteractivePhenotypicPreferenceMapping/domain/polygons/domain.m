...
radialBoundAdaptation = 0.125; %0.25
...
% user zeroFitness
FITNESSFUNCTION             = 'pointAsymmetry';  rmpath(genpath('domain/polygons/fitnessFunctions')); addpath(genpath(['domain/polygons/fitnessFunctions/' FITNESSFUNCTION]));
