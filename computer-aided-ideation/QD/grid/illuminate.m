function [map, percImproved, percValid, allMaps, percFilled, fitnessMean, driftMean, fitnessTotal] = illuminate(constraints,p,d,varargin)
...
% View Initial Map
%    app.fitfun = @(x) objective(x,app.d{app.iter}.fitfun,constraints,app.p{app.iter}.penaltyWeight,app.p{app.iter}.driftThreshold,app.UIAxesSimilaritySpace);
