...
#SBATCH --time=1:20:00           # total runtime of job allocation (format D-HH:MM:SS; first parts optional)
...
matlab -nodisplay -nosplash -nodesktop -r "dataExtractMutrate('/scratch/ahagg2s/GECCO2019/planner_MUTATION_4096', 5, true)"
