function [axHandle, imageHandle, cHandle] = viewMap(map, mapValueStr, varargin)
%VIEWMAP - View Map
%
...
%------------- BEGIN CODE --------------
if nargin > 2; axHandle = varargin{1}; else; figure; axHandle = gca;end

%% TODO PCA when dimensionality of feature space is larger than 1
elites = map.features;
