...
[model.x.hyp, model.x.stats.fX,i] = minimize_gpml(model.x.hyp,@gp, -p.functionEvals, @infExact, p.meanfunc, p.covfunc, p.likfunc, samples, latent(:,1));
%model.x.hyp
%model.x.hyp.cov
%i
%%
...
[model.y.hyp, model.y.stats.fX] = minimize_gpml(model.y.hyp,@gp, -p.functionEvals, @infExact, p.meanfunc, p.covfunc, p.likfunc, samples, latent(:,2));
